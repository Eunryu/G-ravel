...
public class BestRoadLevel2 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> aList = new ArrayAdapter<String>(BestRoadLevel2.this, android.R.layout.simple_dropdown_item_1line, list);
		ListView lv_area = (ListView)findViewById(R.id.lv_BestRoadLevel2_AreaList);
		...
		lv_area.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if(position == 0){
					...
					Intent goNext = new Intent(BestRoadLevel2.this,BestRoadLevel3.class);
